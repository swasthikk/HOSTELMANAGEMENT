...
<html lang="en">
<head>
<title>Hostel Mangement mini Project</title>
...
<section class="contact py-5">
	<div class="container">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> Application Form </h2>
			...
			<form action="application_form.php<?php if(isset($_GET['id'])) { echo '?id=' . $_GET['id']; } ?>" method="post">
					...
					<div class="row">
						...
						<div class="contact-fields-w3ls">
    <input type="text" name="hostel" placeholder="Hostel" value="<?php echo isset($_GET['id']) ? htmlspecialchars($_GET['id']) : ''; ?>" <?php echo isset($_GET['id']) ? 'required' : ''; ?> <?php echo isset($_GET['id']) ? '' : 'disabled="disabled"'; ?>>
</div>
							<div class="contact-fields-w3ls">
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="http://smvitm.ac.in" target="_blank">NIT <span class="display"> </span></a>
		</div>
