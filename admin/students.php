...
if(mysqli_num_rows($result1) == 0){
    ...
    while($row1 = mysqli_fetch_assoc($result1)){
        ...
        if ($result99 && mysqli_num_rows($result99) > 0) {
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="http://www.nitc.ac.in/" target="_blank">SMVITM <span class="display"> </span></a>
		</div>
